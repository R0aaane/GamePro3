...
HemisphereActor::HemisphereActor(Scene* scene, int shaderIndex,
	...
	: MeshActor(scene, pos, vel, angle, avel, scale)
{
	...
	m_mesh = std::make_unique<HemisphereMesh>(this, renderer, shaderIndex, m_modelIndex,
